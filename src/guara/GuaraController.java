...
*/
		...
		tau_abdHip1.set(k4*(0 - q_abdHip0.getValueAsDouble()) + kd4*(0 - qd_abdHip1.getValueAsDouble()));
		tau_abdHip2.set(k4*(0 - q_abdHip0.getValueAsDouble()) + kd4*(0 - qd_abdHip2.getValueAsDouble()));
		tau_abdHip3.set(k4*(0 - q_abdHip0.getValueAsDouble()) + kd4*(0 - qd_abdHip3.getValueAsDouble()));
		
		tau_abdHip0.set(k1*(rob.phiX - q_flexHip0.getValueAsDouble()) + kd1*(0 - qd_flexHip0.getValueAsDouble()));
		tau_abdHip1.set(k1*(rob.phiX - q_flexHip0.getValueAsDouble()) + kd1*(0 - qd_flexHip1.getValueAsDouble()));
		tau_abdHip2.set(k1*(rob.phiX - q_flexHip0.getValueAsDouble()) + kd1*(0 - qd_flexHip2.getValueAsDouble()));
		tau_abdHip3.set(k1*(rob.phiX - q_flexHip0.getValueAsDouble()) + kd1*(0 - qd_flexHip3.getValueAsDouble()));
